...
contract TradeIssuerV2IntegrationmintChamberFromNativeTokenTest is ChamberTestUtils {
    ...
    function testCannotMintWithUnderboughtAsset() public {
        ...
        uint256 totalBaseTokenUsed = tradeIssuer.mintChamberFromNativeToken{
            value: amountWithSlippage
        }(instructions, addyToken, issuerWizard, 500e18);
        assertEq(totalBaseTokenUsed, 0);
    }
    ...
    function testCannotMintAddyWithOverSpentWeth() public {
        ...
        vm.deal(alice, 1);
        deal(tokens["weth"], address(tradeIssuer), amountWithSlippage);
    ...
    function testSuccessMintAddyWithWeth() public {
        ...
        assertEq(alice.balance, amountWithSlippage - totalBaseTokenUsed);
