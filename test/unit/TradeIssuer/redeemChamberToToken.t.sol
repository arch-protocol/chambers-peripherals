...
contract TradeIssuerUnitInternaRedeemChamberToTokenTest is Test {
    /*//////////////////////////////////////////////////////////////
                              VARIABLES
    //////////////////////////////////////////////////////////////*/
    ...
    function testCannotRedeemWithZeroRedeemAmount(
        ...
        vm.mockCall(
            ...
            abi.encodeWithSelector(
                IERC20(address(chamber)).transferFrom.selector,
                address(this),
                address(tradeIssuer),
                chamberAmount
            ),
        ...
        vm.expectCall(
            address(chamber),
            abi.encodeCall(
                IERC20(address(chamber)).transferFrom,
                (address(this), address(tradeIssuer), chamberAmount)
            )
        );

        vm.expectRevert(bytes("Chamber amount cannot be zero"));
        uint256 totalInputTokenUsed = tradeIssuer.redeemChamberToToken(
